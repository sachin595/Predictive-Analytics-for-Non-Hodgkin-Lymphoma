# Predictive Analytics for Non-Hodgkin Lymphoma (NHL)

[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://non-hodgkin-lymphoma-lstm.streamlit.app/)
...
#### In the Context of Predicting Crude Rates for NHL, the LSTM Network's Ability to:
...
- These technical advantages of LSTM networks make them particularly well-suited for our objective of predicting crude rates in NHL, where capturing and modeling temporal dynamics is essential for accurate forecasting. Consequently, the LSTM model was chosen as the primary algorithm for this study, ensuring that the temporal aspect of the data is adequately addressed, leading to more reliable and insightful predictions.
...
- Access the tool here: [Non-Hodgkin Lymphoma Diagnostic Tool](https://non-hodgkin-lymphoma-lstm.streamlit.app/)
- ### Example Output
![Diagnostic Tool Screenshot](NHL_result.png)
